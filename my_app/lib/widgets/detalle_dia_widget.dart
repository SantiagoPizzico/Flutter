...
class DetallesDiaScreen extends StatelessWidget {
  final Clima clima;
  final int index;

  const DetallesDiaScreen({required this.clima, required this.index});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Detalles del Día'),
        centerTitle: true,
      ),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Temperatura máxima: ${clima.temperaturaMaxima[index]}°C',
                  style: const TextStyle(fontSize: 18),
                ),
                Text(
                  'Temperatura mínima: ${clima.temperaturaMinima[index]}°C',
                  style: const TextStyle(fontSize: 18),
                ),
                Text(
                  'Cielo: ${clima.cielo}',
